...
| 10.5 | #52 | USER ACCEPTANCE REVIEW (user walks the whole tool) | ROUND 1 RUN 2026-07-07 — 16 findings filed #54-#69 (Source User review); #69 = round-2 review; #66 + #67 SHIPPED 2026-07-08 (backend `beaadf70`); #58 + #59 + #62 SHIPPED 2026-07-08 (Bundle A, frontend `e3a9a44b`); #63 + #64 SHIPPED 2026-07-21 (backend `2792cefa`, frontend `3cde0d39`); second-to-last; gates GO LIVE |
| 11 | #42 | Chat 10 GO LIVE (F7 real data import) | OPEN — gated behind Phase 10.5 |
| 12 | #43-45 | Deferred TDs (TD1, TD3, TD7) | DEFERRED |
| — | #46-69 | TD21 scheduler (OPEN), TD22 (SHIPPED A), TD36 (SHIPPED A), TD40 (SHIPPED A), #50 news entity mis-tagging (OPEN, Chat 6), #51 dividend_yield ×100 (OPEN, Chat 6), #53 broadened corporate-action cost-basis (OPEN, BLOCKING, Chat 9), #54-#69 user-review findings (OPEN, Phase 10.5) | #46/#50/#51 OPEN; #53 + #54-#69 OPEN except #58/#59/#62 + #66/#67 SHIPPED 2026-07-08 (only #60/#61 non-blocking); #47/#48/#49 SHIPPED |
...
| — | #54-69 | User-review findings (Phase 10.5 round 1): #54 add-new-holding entry, #55 LLM hold-horizon, #56 target/sell-price alerts, #57 news alerts (holdings+watchlist/flagged), #58 nav declutter, #59 audit back-nav, #60 multi-email/Tailscale (doc-prep), #61 one-time deploy script (doc-prep), #62 collapsible dashboard sections, #63 dividends in realised P&L (NOT capital-gains), #64 re-show realised P&L (reverses #40), #65 dividend-announcement capture + drift matrix, #66 9pm heartbeat silent since 2026-06-14, #67 spurious stop-loss fires (GAEL/OLAELEC/RELIANCE — implausible stops), #68 automate corporate-action processing, #69 second user-review round. Source User review; NO renumber. #58 + #59 + #62 SHIPPED 2026-07-08 (Bundle A, frontend `e3a9a44b`); #66 + #67 SHIPPED 2026-07-08 (backend `beaadf70`). | OPEN — all BLOCKING except #60/#61 (#58/#59/#62 + #66/#67 now SHIPPED); source of truth master_todo.md |
