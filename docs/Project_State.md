...
* **#54-#69 (Phase 10.5 / #52 round 1, filed 2026-07-07, Source User review — full detail in master_todo.md):** #54 add-new-holding entry point (not just buy-more), #55 LLM-authored hold-horizon on buy suggestions, #56 target/sell-price breach alerts (mirror of #41 on the intraday path), #57 news alerts for holdings+watchlist/flagged names (depends on #50), #58 dashboard nav declutter, #59 audit page back-to-dashboard nav, #60 multi-email + Tailscale access (doc-prep only), #61 one-time deploy script (doc-prep only), #62 collapsible dashboard sections, #63 dividends shown in realised P&L (income from other sources — NOT capital-gains, /tax untouched), #64 re-show realised P&L (reverses #40), #65 dividend-announcement capture + realised-P&L drift matrix, #66 9pm heartbeat silent since 2026-06-14 (likely #47/TD22 removed the false-positive; wants a positive daily heartbeat — investigation-first), #67 spurious stop-loss fires on implausible stops GAEL/OLAELEC/RELIANCE (data hygiene + sanity guard — investigation-first), #68 automate corporate-action processing (demerger/split/bonus, e.g. TMPV/TMCV), #69 second user-acceptance review round. ALL BLOCKING except #60/#61. GO-LIVE (#42) blocking set: #53, #54, #55, #56, #57, #58, #59, #62, #63, #64, #65, #66, #67, #68, #69.
...
| — | #54-69 | User-review findings (Phase 10.5 round 1): #54 add-new-holding entry, #55 LLM hold-horizon, #56 target/sell-price alerts, #57 news alerts (holdings+watchlist/flagged), #58 nav declutter, #59 audit back-nav, #60 multi-email/Tailscale (doc-prep), #61 one-time deploy script (doc-prep), #62 collapsible dashboard sections, #63 dividends in realised P&L (NOT capital-gains), #64 re-show realised P&L (reverses #40), #65 dividend-announcement capture + drift matrix, #66 9pm heartbeat silent since 2026-06-14, #67 spurious stop-loss fires (GAEL/OLAELEC/RELIANCE — implausible stops), #68 automate corporate-action processing, #69 second user-review round. Source User review; NO renumber. | OPEN — all BLOCKING except #60/#61; source of truth master_todo.md |
