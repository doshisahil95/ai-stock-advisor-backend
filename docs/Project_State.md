...
| — | #54-69 | User-review findings (Phase 10.5 round 1): #54 add-new-holding entry, #55 LLM hold-horizon, #56 target/sell-price alerts, #57 news alerts (holdings+watchlist/flagged), #58 nav declutter, #59 audit back-nav, #60 multi-email/Tailscale (doc-prep), #61 one-time deploy script (doc-prep), #62 collapsible dashboard sections, #63 dividends in realised P&L (NOT capital-gains), #64 re-show realised P&L (reverses #40), #65 dividend-announcement capture + drift matrix, #66 9pm heartbeat silent since 2026-06-14, #67 spurious stop-loss fires (GAEL/OLAELEC/RELIANCE — implausible stops), #68 automate corporate-action processing, #69 second user-review round. Source User review; NO renumber. #66 + #67 SHIPPED 2026-07-08 (backend `beaadf70`). | OPEN — all BLOCKING except #60/#61 (#66/#67 now SHIPPED); source of truth master_todo.md |
