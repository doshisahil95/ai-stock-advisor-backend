...
| 10 | #39-41 | Chat 9 pre-launch cleanup | #39 SHIPPED 2026-07-01 (Chat 9); #40+#41 OPEN (Chat C) |
...
**Open items carried past Chat B** (tracked in master_todo.md; pointer now at #40):
...
* **#40 + #41 (Chat C — NEXT):** realized-P&L UI hide + stop_loss wiring. (#39 F11 capital-gains SHIPPED 2026-07-01.)
